...
SHUFFLED_TRAIN_FILE=$DATA_BASE_FOLDER/$(printf "hollywood2_train_flow_split%02d.txt" $SPLIT)
SHUFFLED_TEST_FILE=$DATA_BASE_FOLDER/$(printf "hollywood2_val_flow_split%02d.txt" $SPLIT)
