...
FEATURE_FOLDER=../../../../internal-data/features/ucf101_features/c3d-ltc-fcan-comp/
SPLIT=1
...
# classification
cd ../evaluate_models
bash classify_clip_and_video_accuracy_ucf101.sh $FEATURE_FOLDER/c3d_rgb_fcan_pool1_sz112_len16_split1_bs64_fi1_iter_20000 $SPLIT rgb_fc8