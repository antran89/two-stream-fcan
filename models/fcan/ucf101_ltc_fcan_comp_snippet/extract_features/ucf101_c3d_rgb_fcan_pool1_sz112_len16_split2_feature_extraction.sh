...
MODEL_PROTOTXT=c3d_rgb_fcan_pool1_sz112_len16_split2_1view_testset.prototxt
BLOB_NAME="rgb_fc8"
...
DATABASE=/media/tranlaman/data/video-snippets-database/ucf101_tvl1_overlapping_len16_train_test_split2
