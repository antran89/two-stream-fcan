...
SHUFFLED_TRAIN_FILE=$DATA_BASE_FOLDER/$(printf "hollywood2_train_rgb_len%d_split%d.txt" $LENGTH $SPLIT)
SHUFFLED_TEST_FILE=$DATA_BASE_FOLDER/$(printf "hollywood2_val_rgb_len%d_split%d.txt" $LENGTH $SPLIT)
