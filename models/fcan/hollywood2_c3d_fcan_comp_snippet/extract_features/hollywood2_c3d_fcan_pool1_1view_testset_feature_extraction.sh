...
MODEL_PROTOTXT=c3d_fcan_pool1_1view_deploy_testset.prototxt
BLOB_NAME="rgb_fc8"
...
DATABASE=/media/tranlaman/data/video-snippets-database/hollywood2_tvl1_comp_overlapping_len16_train_test_split1
