...
MODEL_PROTOTXT=c3d_fcan_pool2_1view_deploy_testset.prototxt
BLOB_NAME="rgb_fc8"
...
DATABASE=/media/tranlaman/data/new-caffe-database/hollywood2_rgb_overlapping_len16_train_test_split1
