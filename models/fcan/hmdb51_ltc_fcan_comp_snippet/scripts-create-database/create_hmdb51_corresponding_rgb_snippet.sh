...
SHUFFLED_TRAIN_FILE=$DATA_BASE_FOLDER/$(printf "hmdb51_train_rgb_len%d_split%02d.txt" $LENGTH $SPLIT)
SHUFFLED_TEST_FILE=$DATA_BASE_FOLDER/$(printf "hmdb51_val_rgb_len%d_split%02d.txt" $LENGTH $SPLIT)
