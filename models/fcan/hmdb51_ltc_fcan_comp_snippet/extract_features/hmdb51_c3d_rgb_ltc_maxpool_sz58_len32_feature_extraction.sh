...
MODEL_PROTOTXT=c3d_rgb_ltc_fcan_maxpool_sz58_len32_1_fc_1view_testset.prototxt
BLOB_NAME="rgb_fc8"
...
DATABASE=/media/tranlaman/data/video-snippets-database/hmdb51_tvl1_overlapping_len32_train_test_split1
