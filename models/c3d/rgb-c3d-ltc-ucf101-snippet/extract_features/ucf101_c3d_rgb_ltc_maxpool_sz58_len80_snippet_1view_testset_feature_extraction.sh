...
MODEL_PROTOTXT=c3d_rgb_ltc_maxpool_sz58_len80_1_fc_snippet_1view_testset.prototxt
BLOB_NAME="rgb_fc8"
...
DATABASE=/media/tranlaman/data/video-snippets-database/ucf101_tvl1_overlapping_len80_train_test_split1
